...
export default function AuditLog() {
  return (
    <>
      <PageHeader
        title="Audit Log"
        description="Tamper-evident IT audit trail of every action — uploads, generations, validations, anonymization, and forwards."
      />
      <Card>
            ...
            <tbody>
              {auditTrail.map((a, i) => (
                <tr key={i} className="border-b last:border-0 hover:bg-muted/20">
                  ...
                  <td className="px-4 py-3 flex items-center gap-2"><ScrollText className="h-3.5 w-3.5 text-accent" />{a.action}</td>
